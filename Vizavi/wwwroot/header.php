<?php
    ...
    if (is_array($url_array) && count($url_array) < 4) {
        if (is_array($url_array) && isset($url_array[1]) && $url_array[1] != "") {
            if (is_array($url_array) && isset($url_array[0]) && $url_array[0] != "") {
                $link = "/" . $url_array[1];
            } else {
                $link = "/ru/" . $url_array[1];
            }
...
<header class="header">
    ...
    <div class="header__main">
        ...
        <div class="header__wrap flex">
            <!-- begin .header__base -->
            <div class="header__base flex"><a class="header__logo header-logo" href="/"><svg fill="none" height="40"
            ...
            <div class="header__aside flex">
                ...
                <div class="header__language">
                    <!-- begin .header__language-action --><button
                        ...
                        title="Сменить язык интерфейса"><span class="language-action__box">
                                <span class="language-action__flag">
                                    <img alt="English language" src="/assets/images/language/en-gb.png" style="width: 20px" />
                                </span>
                                <span class="language-action__icon">
                                    <svg fill="none" height="6" width="9" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <ul class="header__language-list language-list js_language-list">
                        <li class="language-list__item is-active"><a class="language-list__link"
                                href="<? echo htmlspecialchars($link, ENT_QUOTES, 'UTF-8') ?>"><span class="language-list__flag"><img alt="Русский язык"
                                        src="/assets/images/language/ru.png" /> </span> <span
                                    class="language-list__name">Русский</span> </a></li>
                        <li class="language-list__item"><a class="language-list__link" href="javascript:void(0);"><span
                                    class="language-list__flag"><img alt="English language"
                                        src="/assets/images/language/en-gb.png" />
                ...
                <div class="header__user-action"><a class="user-action" href="https://my.vizavi.com/login"
                        title="Авторизация пользователя"><span class="user-action__icon"><svg fill="none" viewBox="0 0 15 15" height="20"
                            ...
                            </svg> </span> <span class="user-action__name">Sign In</span> </a></div>
                ...
                <div class="header__finder-item has_title" id="trading">
                    <div class="finder-menu-icon">
                        <div><svg fill="none" height="42" viewbox="0 0 56 42" width="56"
                            ...
                            <div class="finder-menu-icon_text">Trading</div>
                        </div>
                    </div>

                    <ul class="finder-menu">
                        <li class="finder-menu__item"><a class="finder-menu__link" href="/trading-account">Trading Account</a></li>
                        <li class="finder-menu__item"><a class="finder-menu__link" href="/trading-terminal">trading Terminal</a></li>
                    </ul>
                </div>
                ...
                <div class="header__finder-item has_title" id="about">
                    <div class="finder-menu-icon">
                        <div><svg fill="none" height="75" style="fill: none !important" viewbox="0 0 75 75" width="75"
                            ...
                            <div class="finder-menu-icon_text">About Us</div>
                        </div>
                    </div>

                    <ul class="finder-menu">
                        <li class="finder-menu__item"><a class="finder-menu__link" href="/about">About Us</a></li>
                        <li class="finder-menu__item"><a class="finder-menu__link" href="/partners">To Partners</a></li>
                        <li class="finder-menu__item"><a class="finder-menu__link" href="/safety">Safety of customer funds</a></li>
                        <li class="finder-menu__item"><a class="finder-menu__link" href="/documents">Regulatory documents</a></li>
                        <li class="finder-menu__item"><a class="finder-menu__link" href="/contact-form">Feedback</a></li>
                    </ul>
                </div>
                <!-- end .header__finder-item -->
            </div>
            ...
            <div class="header__finder header-finder js_header-finder">
                ...
                <div class="header__finder-item has_title" id="mobile_nav">
                    <ul class="finder-menu finder-menu_mobile">
                        <li class="finder-menu__item has_child"><a class="finder-menu__link" href="#a">Trading</a>

                            <ul class="finder-menu">
                                <li class="finder-menu__item"><a class="finder-menu__link"
                                        href="/trading-account">Trading Account</a></li>
                                <li class="finder-menu__item"><a class="finder-menu__link"
                                        href="/trading-terminal">Trading Terminal</a></li>
                            </ul>
                        </li>
                        <li class="finder-menu__item"><a class="finder-menu__link" href="/investor">To Investor</a></li>
                        <li class="finder-menu__item has_child"><a class="finder-menu__link" href="#a">About Us</a>
                            <ul class="finder-menu">
                                <li class="finder-menu__item"><a class="finder-menu__link" href="/about">About Us</a></li>
                                <li class="finder-menu__item"><a class="finder-menu__link"
                                        href="/partners">To Partners</a></li>
                                <li class="finder-menu__item"><a class="finder-menu__link" href="/safety">Safety of customer funds</a></li>
                                <li class="finder-menu__item"><a class="finder-menu__link"
                                        href="/documents">Regulatory documents</a></li>
                                <li class="finder-menu__item"><a class="finder-menu__link" href="/contact-form">Feedback</a></li>
                            </ul>
                        </li>
                    </ul>
